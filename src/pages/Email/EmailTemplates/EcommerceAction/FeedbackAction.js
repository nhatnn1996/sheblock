                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "14px", margin: 0 }}>
                                                                    <td className="content-block" style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "15px", verticalAlign: "top", margin: 0, padding: "0 0 0px" }} valign="top">
                                                                        ...
                                                                        <p style={{ fontFamily: "Roboto, sans-serif", marginBottom: "8px", color: "#878a99", lineHeight: 1.5 }}>Feel free to get in touch with us anytime via support from the link below. <Link to="https://themeforest.net/item/sheblockchain-aspnet-core-admin-dashboard-template/36077495/support" target="_blank">https://themeforest.net/item/sheblockchain-aspnet-core-admin-dashboard-template/36077495/support</Link></p>
