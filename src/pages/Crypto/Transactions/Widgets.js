                    ...
                    <CardBody>
                        <div className="d-flex mb-3">
                            <div className="flex-grow-1">
                                <lord-icon
                                    src="https://cdn.lordicon.com/fhtaantg.json" trigger="loop" colors="primary:#6ba92c,secondary:#6ba92c" style={{ width: "55px", height: "55px" }}>
                                </lord-icon>
                            </div>
            ...
            <Col xxl={3} md={6}>
                <Card className="card-animate">
                    <CardBody>
                        <div className="d-flex mb-3">
                            <div className="flex-grow-1">
                                <lord-icon src="https://cdn.lordicon.com/qhviklyi.json" trigger="loop" colors="primary:#6ba92c,secondary:#6ba92c" style={{ width: "55px", height: "55px" }}></lord-icon>
                            </div>
                            <div className="flex-shrink-0">
                                <Link to="#" className="badge badge-soft-warning badge-border">BTC</Link>
                                <Link to="#" className="badge badge-soft-info badge-border">ETH</Link>
                        ...
                        <div className="d-flex mb-3">
                            <div className="flex-grow-1">
                                <lord-icon
                                    ...
                                    trigger="loop"
                                    colors="primary:#6ba92c,secondary:#6ba92c"
                                ...
                                <div className="d-flex mb-3">
                                    <div className="flex-grow-1">
                                        <lord-icon
                                            ...
                                            colors="primary:#6ba92c,secondary:#6ba92c" style={{ width: "55px", height: "55px" }}>
                                        </lord-icon>
                                    </div>
                                    <div className="flex-shrink-0">
