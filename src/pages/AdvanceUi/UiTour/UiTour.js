...
const UiTour = () => {
document.title="Tour | S.H.E Blockchain – Empowering Women in Blockchain";
    return (
        <React.Fragment>
                                                        ...
                                                        <Col lg={4}>
                                                            <Card className="border shadow-none">
                                                                <CardBody className="text-center">
                                                                    ...
                                                                    <h5>Free register</h5>
                                                                    <p className="text-muted mb-0">Get your Free sheblockchain account now.</p>
                                                                </CardBody>
                                                            </Card>
                                                        </Col>
                                                        ...
                                                        <Col lg={4}>
                                                            <Card className="border shadow-none">
                                                                <CardBody className="text-center">
                                                                    ...
                                                                    <p className="text-muted mb-0">Sign in to continue to SheBlockchain.</p>
                                                                </CardBody>
                                                            </Card>
                                                        </Col>
