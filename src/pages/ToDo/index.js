...
const ToDoList = () => {
    document.title = "To Do Lists | S.H.E Blockchain – Empowering Women in Blockchain";
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0">
                            ...
                            <div className="todo-content position-relative px-4 mx-n4" id="todo-content">
                                ...
                                <div className="py-4 mt-4 text-center" id="noresult" style={{ display: "none" }}>
                                    <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#6ba92c,secondary:#6ba92c" style={{ width: "72px", height: "72px" }}></lord-icon>
