...
const Ranking = () => {
    document.title = "Ranking | S.H.E Blockchain – Empowering Women in Blockchain";
                                    ...
                                    {NFTRanking && NFTRanking.length > 0 ? (
                                        ...
                                        <div className="noresult">
                                            <div className="text-center">
                                                <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#6ba92c,secondary:#6ba92c" style={{ width: "75px", height: "75px" }}></lord-icon>
