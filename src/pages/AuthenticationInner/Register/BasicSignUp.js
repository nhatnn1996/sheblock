...
const BasicSignUp = () => {
    document.title = "Basic SignUp | S.H.E Blockchain – Empowering Women in Blockchain";
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form onSubmit={validation.handleSubmit} className="needs-validation" action="#">
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the sheblockchain
