...
const FileManager = () => {
    document.title = "File Manager | S.H.E Blockchain – Empowering Women in Blockchain";
                                    ...
                                    <Row className="justify-content-beetwen g-2 mb-4">
                                        ...
                                        <Col className="col-auto">
                                            <div className="d-flex gap-2 align-items-start">
                                                ...
                                                <button className="btn btn-success text-nowrap create-folder-modal" onClick={() => handleFolderClicks()}><i className="ri-add-line align-bottom me-1"></i> Create Folders</button>
                                            </div>
                                        </Col>
                                    </Row>
