                ...
                <CardBody className="text-center">
                    ...
                    <div className="mb-2">
                        <lord-icon src="https://cdn.lordicon.com/kbtmbyzy.json" trigger="loop"
                            colors="primary:#6ba92c,secondary:#02a8b5" style={{ width: "90px", height: "90px" }}>
                        </lord-icon>
                    </div>
                        ...
                        <table className="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>sheblockchain - Admin Dashboard</td>
                                </tr>
                                <tr>
                    ...
                    <div className="vstack gap-2">
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-13 mb-1"><Link to="#" className="text-body text-truncate d-block">sheblockchain admin.ppt</Link></h5>
                                    <div>2.4MB</div>
                                </div>
                                <div className="flex-shrink-0 ms-2">
                                    <div className="d-flex gap-1">
